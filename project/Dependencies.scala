...
object Dependencies {
  ...
  lazy val `prometheus4cats-contrib-cats-effect` = Seq(
    "com.permutive" %% "prometheus4cats" % "2.0.0",
  ...
  lazy val `prometheus4cats-contrib-fs2-kafka` = Seq(
    ...
    "com.dimafeng"  %% "testcontainers-scala-kafka" % "0.40.14",
    "com.dimafeng"  %% "testcontainers-scala-munit" % "0.40.14",
    "com.permutive" %% "prometheus4cats-java"       % "2.0.0",
    "org.typelevel" %% "cats-effect-testkit"        % "3.5.4",

...
```sbt
"com.permutive" %% "prometheus4cats-contrib-google-cloud-bigtable" % "5.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-cats-effect" % "5.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-fs2-kafka" % "5.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-refreshable" % "5.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-trace4cats" % "5.0.0"
```

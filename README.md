...
```sbt
"com.permutive" %% "prometheus4cats-contrib-google-cloud-bigtable" % "6.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-cats-effect" % "6.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-fs2-kafka" % "6.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-refreshable" % "6.0.0"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-trace4cats" % "6.0.0"
```

...
```sbt
"com.permutive" %% "prometheus4cats-contrib-google-cloud-bigtable" % "7.0.0-RC3"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-cats-effect" % "7.0.0-RC3"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-fs2-kafka" % "7.0.0-RC3"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-refreshable" % "7.0.0-RC3"
```
...
```sbt
"com.permutive" %% "prometheus4cats-contrib-trace4cats" % "7.0.0-RC3"
```
